    ...
    <>
      ...
      <div className="relative" ref={containerRef}>
        ...
        >
          <ul
            ref={navRef}
            className="flex gap-4 list-none p-0 px-8 m-0 relative z-100"
            style={{
              color: "white",
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`rounded-full px-2 relative cursor-pointer transition-[background-color_color_box-shadow] duration-100 ease shadow-[0_0_0.5px_1.5px_transparent] text-white ${
