  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute left-0 top-0 w-1/2 h-full -z-10">
        <Image alt="Left Background" src="/assets/contact/left-background.svg" fill className="object-contain" />
      </div>
      
      {/* Right Background */}
      <div className="absolute right-0 top-0 w-1/2 h-full -z-10">
        <Image alt="Right Background" src="/assets/contact/right-background.svg" fill className="object-contain" />
      </div>
