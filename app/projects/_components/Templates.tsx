...
export default function Templates() {
  ...
  return <div className=''>
      ...
      <div className="py-16 px-4">
        ...
        <div className="flex flex-col gap-12 max-w-sm md:max-w-md mx-auto">
          {products.slice(0, 6).map((product) => (
            <div key={product.title} className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-8 shadow-xl backdrop-blur-sm">
              <h3 className="text-white font-semibold text-lg md:text-xl mb-6">{product.title}</h3>
    ...
    <div className="hidden lg:block">
      <HeroParallax products={products} header={
        <div>
          <GradientText
            colors={["#D1DDFF", '#7B9EFF', 'white',]}
            showBorder={false}
