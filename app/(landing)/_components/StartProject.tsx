        ...
        <div className="relative py-16 md:py-24 lg:py-32 max-w-full lg:max-w-3/4 mx-auto">
          ...
          <div className="flex z-100 flex-col space-y-4 max-w-full md:max-w-1/2 mx-auto">
            <div className="flex flex-col space-y-4 max-w-full md:max-w-sm mx-auto mt-6 md:mt-10 px-4 md:px-0">
              ...
              }} className="cursor-pointer relative w-full rounded-full px-6 md:px-8 py-3 md:py-4 text-white/90 font-semibold text-base md:text-lg bg-linear-to-b from-[#6e7eea] to-[#4956b8] border border-[#a3b3ff]/30 shadow-inner shadow-[#1e1e4a]/40 hover:shadow-[inset_0_0_10px_rgba(255,255,255,0.3)] transition-all duration-300 overflow-hidden">
