    ...
    <div className="w-full max-w-6xl mx-auto px-4">
      ...
      <div className="relative flex items-center justify-center">
        <button
          ...
          className="absolute cursor-pointer left-4 z-50 bg-blue-500 hover:bg-blue-600 text-white rounded-full p-3 transition-colors"
        >
          <ChevronLeft size={24} />
        </button>
        <Swiper
        ...
        <button
          ...
          className="absolute cursor-pointer right-4 z-50 bg-blue-500 hover:bg-blue-600 text-white rounded-full p-3 transition-colors"
        >
